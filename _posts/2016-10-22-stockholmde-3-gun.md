...
{% include figure image_path="/assets/images/stockholmde-3-gun-1.jpeg" caption="Kungsträdgården Park" %}{: .align-center}
...
{% include figure image_path="/assets/images/stockholmde-3-gun-2.jpeg" caption="The Vasa Ship" %}{: .align-center}
...
{% include figure image_path="/assets/images/stockholmde-3-gun-3.jpeg" caption="Nordiska Müzesi" %}{: .align-center}
...
{% include figure image_path="/assets/images/stockholmde-3-gun-4.jpeg" caption="Spritmuseum (a.k.a. Alkol Müzesi)" %}{: .align-center}
...
{% include figure image_path="/assets/images/stockholmde-3-gun-5.png" caption="Skansen" %}{: .align-center}
...
{% include figure image_path="/assets/images/stockholmde-3-gun-6.jpeg" caption="Stockholm City Hall" %}{: .align-center .full}
...
{% include figure image_path="/assets/images/stockholmde-3-gun-7.jpeg" caption="Stockholm Halk Kütüphanesi" %}{: .align-center .full}
...
{% include figure image_path="/assets/images/stockholmde-3-gun-8.jpeg" caption="The Royal Dramatic Theatre" %}{: .align-center}
...
{% include figure image_path="/assets/images/stockholmde-3-gun-9.jpeg" caption="Solda Kraliyet sarayı, sağda parlamento binası" %}{: .align-center}
...
{% include figure image_path="/assets/images/stockholmde-3-gun-10.jpeg" caption="Stortorget ve sağda Nobel Museum" %}{: .align-center}
