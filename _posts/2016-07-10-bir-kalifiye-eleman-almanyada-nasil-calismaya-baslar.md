...
### Almanya’ya Taşınma, Ev Bulma ve Tutma Süreci
...
Ev kiraladıktan sonra elektrik ve suyu üzerinize almanız gerekiyorsa eğer bu işlemleri tamamen **telefon ile** arayarak halledebiliyorsunuz (Almanya’da evde hiçbir zaman elektriksiz ve susuz kalmazsınız. Türkiye’deki gibi birisi gelip elektriği suyu kesmiyor evden taşınınca). [Vattenfall](https://www.vattenfall.de/de/kundenservice-kontakt.htm) (Hamburg ve Berlin için) hotline’ından direkt arayıp elektrik ve ısınma için üyeliğinizi başlatabilirsiniz. Bu tarz şirketleri bulmak çok zor değil. Alacağınız hizmetin Almancasını ve yaşadığınız şehri Google’dan aynı anda aratın, şirketler karşınıza gelir.

Sigortanızı şirket yaptırıyorsa veya kendiniz yaptıracaksanız, sigorta şirketinizi seçmeniz ve kaydolmanız gerek. Bunun sonucunda bir tane kart ve belge alacaksınız. Bu kart ile bütün sağlık işlemlerinizi halledebiliyorsunuz. Her iki durumda da işlem çok basit; [Techniker Krankenkasse](https://www.tk.de/tk/english/610312) (a.k.a TK — İngilizce servisleri mevcut), AOK, SBK gibi kuruluşlara şahsen başvurarak 15–20 dakikada sigorta veya kayıt yaptırabiliyorsunuz. (Ben TK’den yaptırdım sigortamı ve hiçbir problem yaşamadım. Minimum paketinde aylık 175 EUR gibi bir ödeme planı mevcut. Online işlemleri de bulunmakta.)
...
[İş arama ve mülakat süreçleriyle ilgili bilgilere buradan erişebilirsiniz.]({{ site.baseUrl }}/bir-sektorel-profesyonel-icin-almanyada-is-arama-ve-mulakat-surecleri)
{: .notice--success .text-center }

[Peki Almanya’da günlük hayatın nasıl ilerliyor?]({{ site.baseUrl }}/almanyada-gunluk-yasamin-merak-edilenleri)
{: .notice--success .text-center }
